        ...
        import main.java.com.sisop.software.escalonador.Escalonador;
        ...
        public class CPU {
            ...
            public void runFor(int offset) {
                ...
                while (!cpuStop && executed < quantum) {
                            ...
                            if (irpt != Interrupts.noInterrupt) {
                                ih.handle(irpt);
                                cpuStop = true;
                                System.out.println("Interrupcao: acabou");
                        }
                            executed++;
                    }
                if(executed == quantum){
                    irpt = Interrupts.quantumReachedMax;
                    ih.handle(irpt);
                }
            ...
            public void run(boolean traceOn, int offset) {                               // execucao da CPU supoe que o contexto da CPU, vide acima,
                terminouComStop = false;
                cpuStop = false;
